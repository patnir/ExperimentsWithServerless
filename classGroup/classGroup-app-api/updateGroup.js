...
export async function main(event, context, callback) {
  ...
  const params = {
    ...
    Key: {
      classGroupId: event.pathParameters.id
    },
    // 'UpdateExpression' defines the attributes to be updated
    // 'ExpressionAttributeValues' defines the value in the update expression
    UpdateExpression:
      "SET notes = :notes, attachment = :attachment, meetingLocation = :meetingLocation, " +
      "attendanceLimit= :attendanceLimit, commentIds = :commentIds, participantIds = :participantIds, " +
      "meetingTime = :meetingTime, updatedAt = :updatedAt",
